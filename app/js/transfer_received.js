...
const allPaymentOrders = await getDocs(collection(database, 'Card-Transfer'))
...
async function getid(element){
  ...
  const querySnapshot1 = await getDocs(collection(database,'Card-Transfer', element.docID, 'Received'))
